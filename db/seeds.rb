...
apollo = { name: 'Apollo', category: 'Dog', birth: Date.new(2017, 03, 03), adopted: false, owner: nil, adoption_time: nil }
atila = { name: 'Átila', category: 'Dog', birth: Date.new(2016, 11, 02), adopted: false, owner: nil, adoption_time: nil }
